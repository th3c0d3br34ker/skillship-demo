    ...
    <section id="community" className="community-wrapper">
      ...
      <div className="row">
        <div className="col-md-4">
          ...
          <h6 className="p-3">
            <strong>
              Skillship foundation working on the principle of Knowledge sharing
              if you have any knowledge you can pass your knowledge to the next
              person, and the next person will transfer the knowledge to the
              next one.
            </strong>
          </h6>
        </div>
        <div className="col-md-4">
          ...
          <p className="p-3">
            ...
            world.And to direct your passion into productivity; we can give you
        ...
        <div className="col-md-4">
          ...
          <p className="p-3">
            ...
            minds, we give equal openings for those interested in areas such as
            Art, Commercial studies, Competitive exams, Leadership, cultural,
            Govt Sector, Public Speaking and many more.
          </p>
        </div>
      </div>
    </section>
